...
namespace HotelManagementSystem {
    ...
    public ref class AddEditDelete : public System::Windows::Forms::Form
    {
    public:
        AddEditDelete(void)
        {
...
#pragma region Windows Form Designer generated code
        ...
        {
            System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(AddEditDelete::typeid));
            ...
            this->button1->Click += gcnew System::EventHandler(this, &AddEditDelete::button1_Click);
            // 
            // button2
            // 
            ...
            this->button2->Click += gcnew System::EventHandler(this, &AddEditDelete::button2_Click);
            // 
            // button3
            // 
            ...
            this->button3->Click += gcnew System::EventHandler(this, &AddEditDelete::button3_Click);
            // 
            // panel1
            // 
            ...
            this->lbNavigation->Text = L"Room Details";
            this->lbNavigation->TextAlign = System::Drawing::ContentAlignment::MiddleLeft;
            this->lbNavigation->Click += gcnew System::EventHandler(this, &AddEditDelete::lbNavigation_Click);
            // 
            // HMSLabel
            // 
            ...
            this->Name = L"AddEditDelete";
            this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
            this->Text = L"Add Edit Delete";
            this->Load += gcnew System::EventHandler(this, &AddEditDelete::AddEditDelete_Load);
...
#pragma endregion
    private: System::Void AddEditDelete_Load(System::Object^ sender, System::EventArgs^ e) {
    }

    private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
        AddRoom^ addroom = gcnew AddRoom();
        addroom->Show();
    }
    private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
        // Placeholder logic for editing a room or room type
        // Present options for editing
        MessageBox::Show("Editing options presented.", "Edit", MessageBoxButtons::OK);
        EditRoom^ editForm = gcnew EditRoom();
        editForm->ShowDialog();
    }
    private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
        DeleteRoom^ deleteRoom = gcnew DeleteRoom();
        deleteRoom->Show();
    }
