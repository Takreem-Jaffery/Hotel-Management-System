...
namespace HotelManagementSystem {
	...
	/// <summary>
	/// Summary for PaymentsNavigation
	/// </summary>
	public ref class PaymentsNavigation : public System::Windows::Forms::Form
	{
	public:
		PaymentsNavigation(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(PaymentsNavigation::typeid));
			...
			this->btnNewBooking->Text = L"Edit Payments";
			this->btnNewBooking->UseVisualStyleBackColor = false;
			this->btnNewBooking->Click += gcnew System::EventHandler(this, &PaymentsNavigation::btnNewBooking_Click);
			// 
			// btnEditBooking
			// 
			...
			this->btnEditBooking->Text = L"Generate Invoice";
			this->btnEditBooking->UseVisualStyleBackColor = false;
			this->btnEditBooking->Click += gcnew System::EventHandler(this, &PaymentsNavigation::btnEditBooking_Click);
			// 
			// panel1
			// 
			...
			this->HMSLabel->Click += gcnew System::EventHandler(this, &PaymentsNavigation::HMSLabel_Click);
			// 
			// button5
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &PaymentsNavigation::button1_Click);
			// 
			// PaymentsNavigation
			// 
			...
			this->Name = L"PaymentsNavigation";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"PaymentsNavigation";
